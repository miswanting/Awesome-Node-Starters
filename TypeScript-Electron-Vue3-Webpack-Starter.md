...
```bash
mkdir TypeScript-Electron-Vue3-Webpack-Starter
cd TypeScript-Electron-Vue3-Webpack-Starter
git init
mkdir src
cd src
mkdir components
...
```bash
npm i -D typescript electron webpack webpack-cli vue@next
```



```bash
npm i -D typescript electron webpack webpack-cli ts-loader css-loader vue@next vue-loader vue-template-compiler
```
